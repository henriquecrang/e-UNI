<?php  // $Id: sendmail.php,v 1.24 2009/10/19 22:33:00 tmas Exp $
/**
 * This is used to send mails.
 *
 * @author Toni Mas
 * @version $Id: sendmail.php,v 1.24 2009/10/19 22:33:00 tmas Exp $
 * @uses $CFG
 * @package email_list
 ...
 **/
	...
	$mailform = new mail_edit_form('sendmail.php', array('oldmail' => get_record('block_email_list_mail', 'id', $mailid), 'action' => $action), 'post', '', array('name' => 'sendmail'));
...
// DRAFT integration
		...
		if ( $action == EMAIL_FORWARD ) {
			...
			// Get mail
			if ( ! $oldmail = get_record('block_email_list_mail', 'id', $mailid)) {
