 ...
 **/
	...
	if ( $mform->is_cancelled() ) {
	    ...
	    add_to_log($courseid, 'email_list', 'edit preferences', 'preferences.php', 'Edit my preferences', 0, $USER->id);

		$preference = new stdClass();

	    if ( record_exists('block_email_list_preference', 'userid', $USER->id) ) {
	    	...
	    	if ( update_record('block_email_list_preference', $preference) ) {
	    	...
	    	if ( insert_record('block_email_list_preference', $preference) ) {
	    		redirect($CFG->wwwroot.'/blocks/email_list/email/index.php?id='.$courseid, get_string('savedpreferences', 'block_email_list'), '2');
	    	}
	    }
		...
		$preferences = get_record('block_email_list_preference', 'userid', $USER->id);
