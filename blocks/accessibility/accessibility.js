 ...
 * -side, this just gets the necessary bits via AJAX.                  (2)
 *
...
function accessibility_savesize() {
    YAHOO.util.Connect.asyncRequest(
        ...
        {
            success: function(o) {
            accessibility_show_message('Setting saved');
            setTimeout("accessibility_show_message('')", 5000);
            },
            failure: function(o) {
                alert('Error saving text size: '+o.status+' '+o.statusText);
            }
       }
   );
}
...
function accessibility_resetsize() {
    YAHOO.util.Connect.asyncRequest(
        ...
        {
            success: function(o) {
                accessibility_show_message('Setting reset');
                setTimeout("accessibility_show_message('')", 5000);
            },
            failure: function(o) {
                if (o.status != '404') {
                    alert('Error resetting text size: '+o.status+' '+o.statusText);
                }
            }
       }
   );
            ...
            YAHOO.util.Connect.asyncRequest(
                ...
                webroot+'/blocks/accessibility/changesize.php?op=inc',
                {
                    success: function(o) {
                        ...
                        if (stylesheet !== undefined && !stylesheet.disabled) {
                    ...
                    failure: function(o) {
                        alert('Error changing size: '+o.status+' '+o.statusText);
                    }
               }
            );
            break;
...
function accessibility_changecolour(scheme) {
    ...
    YAHOO.util.Connect.asyncRequest(
        ...
        webroot+'/blocks/accessibility/changecolour.php?scheme='+scheme,
        {
            ...
            failure: function(o) {
                alert('Error changing colour: '+o.status+' '+o.statusText);
            }
        }
     );
}
