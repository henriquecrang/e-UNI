...
///$THEME->standardsheets = array('styles_layout');    <- Isso foi comentado
...
/// PROVAVELMENTE TEREMOS QUE ATIVAR DEPOIS
...
$THEME->courseformatsheets = false;
...
$THEME->javascript = $CFG->themewww .'/'. current_theme()/js/popup.js ;
