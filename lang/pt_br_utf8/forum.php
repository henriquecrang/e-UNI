...
$string['cannotadddiscussionall'] = 'Você não tem permissão para abrir um novo tópico de discussão para totos os participantes.';
...
$string['deletesureplural'] = 'Tem certeza que quer apagar esta mensagem e todas as respostas? ($a mensagens)';
...
$string['forum:viewqandawithoutposting'] = 'Ver sempre mendagens Q e A';
...
$string['mailnow'] = 'mandar email agora';
...
$string['resetforums'] = 'Apagar as mensagens de';
$string['resetforumsall'] = 'Apagar todas as mensagens';
$string['resetsubscriptions'] = 'Remover as assinaturas';
$string['resettrackprefs'] = 'Apagar todas as preferências de rastreamento dos fóruns';
...
$string['unsubscribeallempty'] = 'Sinto muito mas você não é assinante de nenhum fórum. Para evitar totalmente o recebimento de emails deste server é necessario desabilitar o endereço email no seu perfil de usuário.';
