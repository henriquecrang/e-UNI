...
$string['assessmentofresubmission'] = 'Esta é uma avaliação de uma nova versão de um documento.<br /> O formulário contém atualmente as notas e comentários correspondentes à versão anterior do documento.<br />Corrija estas notas após a leitura da nova versão do doceumento.';
