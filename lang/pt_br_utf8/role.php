<?PHP // $Id: role.php,v 1.5 2009/10/11 16:35:31 papita Exp $ 
...
$string['deletecourseoverrides'] = 'Remover todas as sobreposições no curso';
$string['deletelocalroles'] = 'Remover todas as designações de funções locais';
...
$string['legacy:coursecreator'] = 'FUNÇÃO HERDADA: Autor de curso';
$string['legacy:editingteacher'] = 'FUNÇÃO HERDADA: Tutor (editor)';
$string['legacy:guest'] = 'FUNÇÃO HERDADA: Visitante';
$string['legacy:student'] = 'FUNÇÃO HERDADA: Estudante';
$string['legacy:teacher'] = 'FUNÇÃO HERDADA: Tutor (não editor)';
...
$string['site:langeditlocal'] = 'Cutomizar tradução local';
