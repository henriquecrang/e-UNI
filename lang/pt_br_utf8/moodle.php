...
$string['activityiscurrentlyhidden'] = 'Sinto muito, por enquanto esta atividade não pode ser acessada';
...
$string['adminbookmarks'] = 'Administrar favoritos';
...
$string['adminhelpassignteachers'] = 'Para acrescentar tutores, selecionar um curso e usar o seguinte símbolo associado:';
...
$string['backupexecuteathelp'] = 'Indicar o orário em que o backup deve iniciar';
...
$string['backupincludemoduleuserdatahelp'] = 'Decida se você quer incluir os dados de usuário dos módulos no backup.';
...
$string['backuplogshelp'] = 'Se ativado, então os logs dos cursos serão incluidos nos backups automáticos';
...
$string['block'] = 'Bloco';
$string['blockconfiga'] = 'Configurando un bloco $a';
$string['blockconfigbad'] = 'Este bloco não foi implementado corretamente e não compreende uma interface de configuração';
$string['blockdeleteconfirm'] = 'Você está cancelando o bloco \'$a\'. Todas as informações e dados associados a este bloco serão cancelados da base de dados. Continuar?';
$string['blockdeletefiles'] = 'Os dados associados ao bloco \'$a->block\' foram cancelados da base de dados. Para completar o cancelamento e evitar que o bloco reapareça, você deve cancelar o seguinte diretório no servidor: $a->directory';
...
$string['categorymodifiedcancel'] = 'Categoria modificada!Tente de novo.';
...
$string['checkingbackup'] = 'Controlando o backup';
...
$string['clamfailed'] = 'Clam AV não funcionou. A mensagem de erro foi $a. Eis o resultado de Clam:';
...
$string['cleaningtempdata'] = 'Cancelando dados temporários';
...
$string['coursecreatorsdescription'] = 'Autores de cursos podem criar novos cursos e agir como professores';
...
$string['defaultcourseteacher'] = 'Professor-Coordenador';
$string['defaultcourseteacherdescription'] = 'Professores-Coordenadores podem fazer tudo em um curso, alterar atividades e avaliar.';
$string['defaultcourseteachers'] = 'Professores-Coordenadores';
$string['delete'] = 'Cancelar';
$string['deleteall'] = 'Cancelar todos';
$string['deleteallcomments'] = 'Cancelar todos os comentários';
$string['deleteallratings'] = 'Cancelar todas as pontuações';
$string['deletecategory'] = 'Apagar categoria: $a';
$string['deletecategorycheck'] = 'Você tem certeza que deseja cancelar definitivamente esta categoria <b>\'$a\'</b>?<br />Os cursos serão transferidos para a categoria superior, se presente, ou para a categoria padrão';
$string['deletecategorycheck2'] = 'Se você apagar esta categoria, escolha o que fazer com seus cursos e subcategorias.';
$string['deletecheck'] = 'Cancelar $a ?';
$string['deletecheckfiles'] = 'Você tem certeza que deseja cancelar definitivamente estes arquivos?';
$string['deletecheckfull'] = 'Você tem certeza que deseja cancelar definitivamente $a ?';
...
$string['edhelpenablespelling'] = 'Ativar ou desativar o contrôle ortográfico. Para a ativação é necessária que <strong>aspell</strong> esteja instalado no servidor.';
...
$string['editlock'] = 'Este valor não pode ser modificado!';
...
$string['emaildigestoff'] = 'Nenhum (um email para cada nova mensagem do fórum)';
...
$string['enrolmentkeyfromguest'] = 'Este curso exige uma chave de acesso para os visitantes.';
...
Se você chegou aqui a partir de um link em um email, pode ser que a linha de endereço do link tenha sido alterada pelo programa de correio eletrônico. Neste caso, tente copiar o link inteiro e colocar na barra de endereços de um navegador para que o percurso seja reconstruído em modo correto.';
...
$string['existingcourseadding'] = 'Curso existente, adicionando dados';
$string['existingcoursedeleting'] = 'Cancelando curso existente';
$string['existingcreators'] = 'Autores de curso existentes';
$string['existingstudents'] = 'Participantes inscritos';
$string['existingteachers'] = 'Tutores existentes';
...
$string['hiddenassign'] = 'Tarefa oculta';
...
$string['idnumbertaken'] = 'Este número ID já está sendo usado';
...
$string['loginalready'] = 'Você já fez o login';
...
<li>Se for pedido um código de inscrição use a senha que foi fornecida pelo administrador ou pelo tutor. Esta senha é reservada aos usuários do site inscritos no curso e será necessária apenas na primeira vez que você entrar no curso.</li>
...
$string['none'] = 'Nenhum';
$string['noneditingteacher'] = 'Professor-Tutor';
$string['noneditingteacherdescription'] = 'Professores-Tutores podem interagir e avaliar mas não podem modificar as atividades.';
...
$string['nopotentialstudents'] = 'Nenhum estudante em potencial';
...
$string['olduserdirectory'] = 'Este é o velho diretório de usuários. Você pode apagar este diretório pois os arquivos forma copiados no novo diretório de usuários.';
...
$string['resetinfo'] = 'Esta página permite que você esvazie os dados de um curso ou de um usuário, sem cancelar as atividades e outras configurações. Por favor lembre-se que fazendo isto estes dados serão cancelados para sempre!';
...
$string['role'] = 'Papel';
$string['rolemappings'] = 'Mapping de funções';
$string['rolerenaming'] = 'Mudança de nome da função';
...
$string['statisticsgraph'] = 'Grãfico de estatísticas';
...
$string['unzippingbackup'] = 'Descompactar backup';
$string['up'] = 'Para cima';
...
$string['warningdeleteresource'] = 'Arenção: $a é citado em um recurso. Você quer atualizar este recurso?';
...
$string['youaregoingtorestorefrom'] = 'Você vai fazer a restauração de';
$string['youneedtoenrol'] = 'Para realizar esta ação você tem que ser inscrito neste curso.';
...
// daqui pra baixo adicionado para o euni

$string['youhave'] = 'Você tem';
