<?PHP // $Id: tag.php,v 1.1 2008/09/20 23:08:35 papita Exp $ 
...
$string['deleted'] = 'Removido';
$string['description'] = 'Descrição';
$string['edittag'] = 'Editar esta tag';
$string['flag'] = 'Marca';
$string['flagasinappropriate'] = 'Marque como não apropriada';
...
$string['thingstaggedwith'] = '$a->count itens ligados com \"$a->name\"';
...
$string['userstaggedwith'] = 'Usuários com tag \"$a\"';
