<?PHP // $Id: search.php,v 1.1 2008/09/20 23:08:35 papita Exp $ 
      // search.php - created with Moodle 1.9.2+ (Build: 20080903) (2007101522)
...
$string['checkdiradvice'] = 'Controle se o diretório de dados existe e tem permissão para escrita';
$string['commenton'] = 'Comentar sobre';
$string['createanindex'] = 'criar um índice';
$string['createdon'] = 'Criado sobre';
...
$string['invalidindexerror'] = 'O diretório do índice ou contém um índice invalido ou está vazio';
$string['ittook'] = 'Durou';
$string['next'] = 'Próxima';
...
$string['type'] = 'Tipo';
$string['uncompleteindexingerror'] = 'A indexação não foi completada com sucesso, por favor tente outra vez.';
$string['versiontoolow'] = 'Sinto muito, a pesquisa global requer PHP 5.0.0 ou mais recente';
$string['whichmodulestosearch?'] = 'Quais módulos pesquisar?';
