...
$string['allowemailaddresses'] = 'Domínios email autorizados';
...
$string['configcreatornewroleid'] = 'Este papel é atribuído automaticamente aos criadores de novos cursos. Este papel não é atribuído se o criador já necessitou das capacidades em um contexto superior.';
...
$string['configdefaultuserroleid'] = 'Todos os usuários logados terão as capacidades da função especificada aqui, em nível global, em ADIÇÃO a quaisquer outras funções que eles possuam. O padrão é o papel de usuário Autenticado (ou papel de Visitante em versões mais antigas). Note que isso não provocará conflito com as outras funções do usuário, apenas permitirá que eles tenham privilégios que não podem ser atribuídos em nível de curso (ex: posts em blog, gerenciamento de calendário, etc)';
...
$string['confignotloggedinroleid'] = 'Usuários que não estão conectados ao site serão tratados como se eles tivessem esse papel que lhes é concedido em âmbito local. Você deve preferir quase sempre que o usuário tenha função de visitante, mas talvez você queira criar papéis que são menos ou mais restritivos. Com a criação de posts pode-se exigir que o usuário se autentique adequadamente.';
...
$string['configrecaptchaprivatekey'] = 'Cadeia de caracteres usada para comunicar o servidor do seu Moodle e o servidor recaptcha.net. Obtenha uma para este site visitando http://recaptcha.net';
...
$string['configsendcoursewelcomemessage'] = 'Se habilitato os usuários recebem uma mensagem de bem-vindos por email quando fazem a inscrição em um curso.';
...
$string['configstatsmaxruntime2'] = 'O processamento das estatísticas pode ser bastante intensivo, especifique o tempo máximo que será permitido para a coleta de estatísticas de um dia. O máximo de dias processado em uma execução do cron é 3.';
...
$string['configteacherassignteachers'] = 'Os docentes podem adicionar outros docentes em seus cursos? Se \'Não\', apenas os autores de cursos e administradores poderão adicionar outros docentes.';
...
$string['deleteerrors'] = 'Remover erros';
$string['deleteincompleteusers'] = 'Remover usuários incompletos depois de';
$string['deleteunconfirmed'] = 'Remover usuários não confirmados depois de';
$string['deleteuser'] = 'Remover usuário';
...
$string['enablegroupings'] = 'Habilitar grupos';
...
$string['extendedusernamechars'] = 'Permitir caracteres extendidos em nome de usuários';
...
$string['geoipfile'] = 'Arquivo de informaçoes do GeoIP City';
...
$string['guestroleid'] = 'Função designada ao visitante';
...
$string['loglifetime'] = 'Anotar no log para';
...
$string['mnetrestore_extusers_mismatch'] = '<strong>Nota:</strong> Este arquivo de backup aparentemente provém de uma instalação Moodle diferente e possui contas de usuários remotos da Rede Moodle que podem falhar ao retaurar. Esta operação não é aceita. Se você está certo de que isto foi criado nesta instalação Moodle, ou você pode assegurar que todos os Hosts da Rede Moodle necessários estão configurados ou você pode querer ainda tentar restaurá-los.';
...
$string['notloggedinroleid'] = 'Função para pessoas não logadas (turistas)';
...
$string['profilemenutoofewoptions'] = 'Voce deve fornecer pelo menos 2 opções';
...
$string['simpletest'] = 'Unidades de teste';
...
$string['stripalltitletags'] = 'Temover tags HTML de todos os nomes das atividades';
...
$string['userbulk'] = 'Ações em conjunto de usuários';
$string['userdeleted'] = 'Usuário removido';
...
$string['usersdeleted'] = 'Usuários removidos';
