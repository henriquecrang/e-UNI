<?PHP // $Id$ 
      // journal.php - created with Moodle 1.6 development (2006031600)
...
$string['journalmail'] = '$a->teacher comentou a sua anotação no diário \'$a->journal\'
...
$string['noratinggiven'] = 'Nenhuma avaliação feita';
