<?PHP // $Id$ 
      // assignment.php - created with Moodle 1.9.2+ (Build: 20080903) (2007101522)
...
$string['nosubmitusers'] = 'Nenhum usuário com permissão de enviar esta tarefa';
...
$string['onceassignmentsent'] = 'Depois de enviar a tarefa para avaliação não será possível cancelar ou anexar documentos.';
...
$string['allowmultiple'] = 'Permitir arquivos múltiplos'; // ORPHANED
$string['attachfile'] = 'Anexar arquivo'; // ORPHANED
$string['attachfiletoassignment'] = 'Anexar arquivo(s) à tarefa'; // ORPHANED
$string['backtoassignment'] = 'Retornar à tarefa'; // ORPHANED
$string['backtofeedback'] = 'Retornar ao feedback'; // ORPHANED
$string['choosereviewfile'] = 'Escolher um arquivo para carregar como revisão da tarefa'; // ORPHANED
$string['deletecheckfile'] = 'Tem certeza que quer cancelar este arquivo?'; // ORPHANED
$string['deleteednotification'] = 'O arquivo foi cancelado'; // ORPHANED
$string['deletefail'] = 'O seguinte arquivo não foi cancelado:'; // ORPHANED
$string['markingsubmitnotification'] = 'O arquivo foi enviado para avaliação.'; // ORPHANED
$string['namedeletefile'] = 'Você está cancelando este arquivo:'; // ORPHANED
$string['nofilesforsubmit'] = 'Nenhum arquivo encontrado - você tem certeza que carregou o arquivo no site?'; // ORPHANED
$string['removelink'] = 'Remover'; // ORPHANED
$string['responsefile'] = 'Arquivo de resposta:'; // ORPHANED
$string['responsesfromteacher'] = 'Respostas enviadas pelo professor'; // ORPHANED
$string['step1'] = 'Passo 1:'; // ORPHANED
$string['step2'] = 'Passo 2:'; // ORPHANED
$string['submissionstatus'] = 'Status do documento:'; // ORPHANED
$string['submissionstatusblank'] = 'Em branco'; // ORPHANED
$string['submissionstatusdraft'] = 'Esboço'; // ORPHANED
$string['submissionstatusmarked'] = 'Avaliado'; // ORPHANED
$string['submissionstatusreturned'] = 'Devolvido'; // ORPHANED
$string['submissionstatussubmitted'] = 'Enviado'; // ORPHANED
$string['uploadsuccessresponse'] = 'Archivo de resposta enviado com sucesso'; // ORPHANED
