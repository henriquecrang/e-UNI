...
$string['allowstrippages'] = 'Permitir \'apagar páginas\'';
...
$string['overrideinfo'] = 'Você pode ignorar o bloqueio criado por este usuário mas isto pode causar a perda das alterações criadas por ele. Cuidado.';
...
$string['removenotice'] = 'Apenas as páginas sem referências serão listadas. Ewiki faz um teste limitado das páginas com referências e algumas delas podem estar faltando na lista.<br />Se você esvaziar uma página antes, ela será listada. Muitos outros diagnósticos da base de dados são realizados.';
...
$string['revertlastonly'] = 'Sómente se esta era a última alteração';
...
$string['strippagecheck'] = 'Tem certeza que quer apagar as versões antigas destas páginas?';
$string['strippages'] = 'Apagar páginas';
...
$string['versionrangetoobig'] = 'Não é possível apagar todas as versões de uma página! A última versão deve ser mantida.';
