<?PHP // $Id: quiz_overview.php,v 1.3 2008/09/20 19:30:37 papita Exp $ 
      // quiz_overview.php - created with Moodle 1.9.2+ (Build: 20080903) (2007101522)
...
$string['deleteselected'] = 'Apagar tentativas selecionadas';
...
$string['optonlygradedattempts'] = 'apenas a tentativa avaliada de cada usuário ($a)';
$string['overview'] = 'Sinopse';
$string['overviewdownload'] = 'Baixar sinopse';
$string['overviewreportgraph'] = 'Gráfico: número de alunos por faixas de nota';
...
$string['show'] = 'Mostrar / baixar';
$string['showdetailedmarks'] = 'Mostrar / baixar notas de cada questão';
